...
public class WidgetBlockListEntry extends WidgetListEntryBase<Identifier>
{
    private final Identifier blockId;
    private final boolean isOdd;

    public WidgetBlockListEntry(int x, int y, int width, int height, boolean isOdd,
            Identifier blockId, int listIndex, WidgetListBlockIds parent)
    {
        super(x, y, width, height, blockId, listIndex);
    ...
    public void render(GuiContext ctx, int mouseX, int mouseY, boolean selected)
    {
        ...
        this.drawString(ctx, this.x + 4, this.y + 4, color, this.blockId.toString());
