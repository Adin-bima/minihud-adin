...
public class WidgetListBlockIds extends WidgetListBase<Identifier, WidgetBlockListEntry>
{
    private String filter = "";

    public WidgetListBlockIds(int x, int y, int width, int height, float zLevel,
    ...
    {
        Set<Identifier> ids = HighlighterConfigs.getAllBlockIds();
    ...
    @Override
    protected WidgetBlockListEntry createListEntryWidget(int x, int y, int listIndex, boolean isOdd, Identifier entry)
    {
        return new WidgetBlockListEntry(x, y, this.browserEntryWidth, this.getBrowserEntryHeightFor(entry), isOdd, entry, listIndex, this);
    }
}
