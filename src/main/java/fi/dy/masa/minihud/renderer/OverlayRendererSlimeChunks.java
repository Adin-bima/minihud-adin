...
public class OverlayRendererSlimeChunks extends OverlayRendererBase {
    ...
    private void renderQuads(Vec3 cameraPos, Minecraft mc, ProfilerFiller profiler) {
        ...
        BufferBuilder builder = ctx.start(() -> "minihud:slime_chunk/quads",
                this.renderThrough ? MaLiLibPipelines.POSITION_COLOR_MASA_NO_DEPTH_NO_CULL
    ...
    private void renderOutlines(Vec3 cameraPos, Minecraft mc, ProfilerFiller profiler) {
        ...
        final Color4f colorLines = Color4f.fromColor(Configs.Colors.SLIME_CHUNKS_OVERLAY_COLOR.getColor().getIntValue(),
                0xFF);
        profiler.push("slime_chunk_outlines");
        RenderObjectVbo ctx = this.renderObjects.get(1);
        BufferBuilder builder = ctx.start(() -> "minihud:slime_chunk/outlines",
