...
public class RenderContainer {
    ...
    private RenderContainer() {
        ...
        this.addRenderer(OverlayRendererBlockHighlighter.INSTANCE);
        this.addRenderer(OverlayRendererMobHighlighter.INSTANCE);
        this.addRenderer(OverlayRendererPlayerHighlighter.INSTANCE);
    }
